...
const Signup = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-r from-blue-900 to-blue-600 px-4">
      <div className="bg-white shadow-2xl rounded-3xl p-10 w-full max-w-4xl transform transition-transform duration-300 hover:scale-105">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            className="w-full py-4 bg-blue-600 text-white rounded-2xl shadow hover:bg-blue-700 transition duration-300 text-lg font-semibold"
          >
            Signup
          </button>
