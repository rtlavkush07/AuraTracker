...
const Assignment = () => {
    ...
    const isAssignmentSubmittedByUser = (assignment) =>
        assignment.submittedBy.some(
        ...
        >
            ...
            <div className="flex justify-center mb-4">
                <button
                    ...
                    className={`px-4 py-2 ${activeTab === "Pending" ? "bg-red-800" : "bg-gray-800"
                ...
                <button
                    ...
                    className={`px-4 py-2 ${activeTab === "Submitted" ? "bg-green-800" : "bg-gray-800"
                        } border border-gray-400 rounded-r-lg`}
                >
                    Submitted
                </button>
            </div>
            ...
            {subjects?.map((subject, subjectIndex) => (
                ...
                <div key={subject.subjectName} className="mb-6">
                    ...
                    {subject.assessments &&
                        subject.assessments
                            .filter((assignment) => {
                                const isSubmitted = isAssignmentSubmittedByUser(assignment);
